Vue.component("tetris-item", {
  ...
  <main>
    <div class="container">
        ...
        (人名敬称略)
        <br />
        当時友達とポケモンをやっていた関係で、たけひこ(まめねこ)というポケモン生主の配信を見てた
        <br />
        たけひこはTOJのテトリス配信もしていたので、その配信も見てた
        <br />
        テトリスに興味を持ったので、たけひこ経由で知ったへぼまい、刑事ニコニコの配信を見始める
        <br />
        面白そうだったのでTOJを始めてオンラインで遊ぶ
        <br />
        へぼまい、Blink、あじゃんば、milk2の配信を見ながら火力の作り方とかを覚える
        <br />
        -- 数年が経過 --
        <br />
        久しぶりにテトリス界隈の配信を覗いてみると、テトリス界隈の強さがインフレしてることに気付く
        <br />
        ふれあ、kazu、あめみやたいようの配信を見ながら火力の作り方とかを覚える
        </p>
    </div>
    </main>
  `,
